...
import { bootTestApp, TestApp } from './test-app';
...
describe('Tenant Isolation (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    org1Token = jwtService.sign({ sub: 'user1', email: 'u1@test.com', orgId: 'org-test-1', role: 'Organization Admin' });
    org2Token = jwtService.sign({ sub: 'user2', email: 'u2@test.com', orgId: 'org-test-2', role: 'Organization Admin' });
  });
