...
export class UsersService {
  ...
  static async inviteUser(data: { email: string; role: string; name?: string; territoryIds?: string[]; mobile?: string }): Promise<{ message: string; user: User; inviteToken?: string }> {
