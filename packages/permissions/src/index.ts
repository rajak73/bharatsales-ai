...
const PermissionsByRole: Record<Role, Partial<Record<Resource, Action[]>>> = {
  ...
  'Organization Admin': {
    ...
    [Resource.Attendance]: [Action.Read, Action.Update, Action.Approve, Action.Export],
    ...
    [Resource.Hierarchy]: [Action.Create, Action.Read, Action.Update, Action.Delete],
    [Resource.Beats]: [Action.Create, Action.Read, Action.Update, Action.Delete, Action.Approve],
    [Resource.Invoices]: [Action.Create, Action.Read, Action.Export],
  },
  'Sales Manager': {
    ...
    [Resource.Analytics]: [Action.Read, Action.Export],
    [Resource.Approvals]: [Action.Read, Action.Approve],
    // Beat *templates* are Organization Admin's job to create/edit; a Sales
    // Manager may only read them and "Approve" — i.e. assign an already-
    // published template to a rep on their own team (see BeatsService.assignBeat).
    [Resource.Beats]: [Action.Read, Action.Approve],
    [Resource.LiveMap]: [Action.Read],
    [Resource.Schemes]: [Action.Read],
    [Resource.Attendance]: [Action.Read, Action.Approve, Action.Export],
    [Resource.Visits]: [Action.Read, Action.Export],
    [Resource.PriceLists]: [Action.Read],
    [Resource.TaxRates]: [Action.Read],
    // Distributor *onboarding* is Organization Admin's job per BRD; a Sales
    // Manager coordinates with distributors but doesn't create them.
    [Resource.Distributors]: [Action.Read, Action.Update],
    [Resource.Notifications]: [Action.Read, Action.Update],
    [Resource.Dispatch]: [Action.Read],
    [Resource.Invoices]: [Action.Read],
  },
  'Sales Representative': {
    [Resource.Attendance]: [Action.Create, Action.Read, Action.Update],
