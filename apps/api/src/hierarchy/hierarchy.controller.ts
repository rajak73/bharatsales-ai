...
@RequirePermissions(Resource.Hierarchy, Action.Read)
  @Get()
...
@RequirePermissions(Resource.Hierarchy, Action.Create)
  @Post()
...
@RequirePermissions(Resource.Hierarchy, Action.Update)
  @Put(':id')
    @AuditEntity('HierarchyNode')
...
@RequirePermissions(Resource.Hierarchy, Action.Delete)
  @Delete(':id')
    @AuditEntity('HierarchyNode')
