...
const CheckCircle2 = CheckCircle2Base as any;
      ...
      <div className="hidden lg:flex w-1/2 bg-[#2D3A8C] flex-col justify-between p-16 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-bold leading-tight mb-6">
            Bring your distribution<br />network online.
          </h2>

          <p className="text-blue-100 text-lg mb-12 max-w-md leading-relaxed">
            Set up your organization in minutes. A platform administrator reviews and approves every new workspace before it goes live.
          </p>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          {submitted ? (
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mb-3 tracking-tight">Registration Submitted</h2>
              <p className="text-slate-500 text-sm mb-8 leading-relaxed">
                Your organization <span className="font-semibold text-slate-700">{companyName}</span> is awaiting platform administrator approval.
                You&apos;ll be able to sign in once it&apos;s approved.
              </p>
              <NavLink
                href="/login"
                className="inline-flex items-center justify-center py-3 px-6 rounded-xl text-sm font-bold text-white bg-[#2D3A8C] hover:bg-[#1e2761] transition-all"
              >
                Back to Sign In
              </NavLink>
            </div>
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-slate-500 text-sm">Register your organization to get started.</p>
              </div>

              {error && (
                <div className="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl text-sm flex items-center gap-3">
                  <span className="w-5 h-5 rounded-full bg-red-100 flex items-center justify-center text-xs font-bold text-red-600 shrink-0">!</span>
                  {error}
                </div>
              )}
              ...
              <form onSubmit={handleSignup} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex justify-center items-center py-3.5 px-4 rounded-xl text-sm font-bold text-white bg-[#2D3A8C] hover:bg-[#1e2761] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2D3A8C] disabled:opacity-70 transition-all mt-2"
                >
                  {loading ? (
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-slate-500">
                  Already have an account? <NavLink href="/login" className="font-semibold text-[#2D3A8C] hover:underline">Sign In</NavLink>
                </p>
              </div>
            </>
          )}
