  ...
  return (
    <div className="bg-background min-h-screen font-sans pb-24">
      <div className="bg-navy-900 px-4 pt-10 pb-4 shadow-md sticky top-0 z-40">
        ...
        <p className="text-navy-200 text-sm mt-0.5">Retail shops on today's route</p>
      </div>
      ...
      <div className="px-4 py-4 space-y-3">
        ...
        {!activeSession ? (
          ...
          smartBeatOutlets.map((outlet) => (
            <div key={outlet.id} className="bg-white rounded-2xl p-4 shadow-sm border border-border relative overflow-hidden">
                ...
                <div className="flex-1 min-w-0 pr-16">
                  ...
                  {outlet.visitStatus === 'visited' ? (
                    <div className="flex items-center gap-2 mt-1">
                      <p className="text-xs text-foreground-muted">Visited</p>
